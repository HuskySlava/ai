...
> **Note:** Ollama is a local AI model manager and inference engine that allows you to run large language models on your own machine. It must be **installed and configured separately**. See [Download Ollama](https://ollama.com/download).  
